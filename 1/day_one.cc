 ...
 * @author Conor Rojas
 * @date 4/21/23
 * @brief The Evles would like to know how many Calories are being carried by the Elf carrying the most Calories.
 *
 * Exercise 1: Find the Elf carrying the most Calories. How many total Calories is that Elf carrying?
 * Exercise 2: Find the top three Elves carrying the most Calories. How many Calories are those Elves carrying in total?
 */
